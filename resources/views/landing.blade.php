...
<head>
  ...
  <link rel="stylesheet" href="{{asset('landpage')}}/assets/css/templatemo-tale-seo-agency.css">
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="{{asset('landpage')}}/assets/images/logo.png" alt="" style="max-width: 112px;">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('landpage')}}/assets/images/services-01.jpg" alt="discover SEO" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('landpage')}}/assets/images/services-02.jpg" alt="data analysis" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('landpage')}}/assets/images/services-03.jpg" alt="precise data" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('landpage')}}/assets/images/services-04.jpg" alt="SEO marketing" class="templatemo-feature">
                </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="left-image">
                  <img src="{{asset('landpage')}}/assets/images/left-infos.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="section-heading">
  ...
  <script src="{{asset('landpage')}}/assets/js/tabs.js"></script>
  <script src="{{asset('landpage')}}/assets/js/popup.js"></script>
